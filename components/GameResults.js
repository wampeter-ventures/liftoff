        ...
        if (wolfOutcome) {
            if (wolfOutcome === 'success') {
                return {
                    ...
                    description:
                        `You did it! You actually did it. Against all cosmic odds, your rocket punched through the edge of our solar system and landed in the mysterious Wolf 1061 system—13.8 light-years away and just maybe, possibly, PROBABLY crawling with adorable, weird, pizza-loving aliens.\nYour crew is now legendary. Your boosters are the stuff of bedtime stories. Your rocket is…well, a little charred, but wow.\n\nBut wait. Did you know real astronomers think Wolf 1061c might ACTUALLY have the right conditions for life?\n👾 There could be oceans. There could be alien hamsters. There could be…you, if you build fast enough.\n\nCurious? Go down the rabbit hole:\nCould Wolf 1061c Host Life? (Wikipedia) https://en.wikipedia.org/wiki/Wolf_1061`,
