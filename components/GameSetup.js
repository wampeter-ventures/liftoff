...
function GameSetup({ onStartGame, onBack }) {
      ...
      <Card className="shadow-none border-none rounded-none">
        <CardContent className="space-y-4 p-4 pt-8">
          ...
          <div>
            ...
            <Select value={String(playerCount)} onValueChange={(value) => setPlayerCount(Number(value))}>
