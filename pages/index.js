                                    ...
                                    >
                                        ...
                                        <div className="fire-dice-container">
                                            {fireDice.map((die, index) => (
                                                <div
                                                    key={die.id}
                                                    className={`fire-flame fire-flame-${index + 1} ${fireOverflow ? 'fire-flame-grow' : ''}`}
                                                >
                                ...
                                <div className="game-controls">
                                    ...
                                    <div className="fire-status fire-bottom">
                                        ...
                                        >
                                            ...
                                            <div className="fire-dice-container">
                                                {fireDice.map((die, index) => (
                                                    <div key={die.id} className={`fire-flame fire-flame-${index + 1} ${fireOverflow ? 'fire-flame-grow' : ''}`}>
                                                        <Flame size={24} className="flame-icon" />
                                                    </div>
                                                ))}
                                                {Array.from({ length: 5 - firePile }, (_, i) => (
