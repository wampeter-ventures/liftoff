...
export default function Home() {
    ...
    const WelcomePlanets = () => (
        <>
            {/* Saturn */}
            <div className="absolute top-1/4 left-1/6 animate-spin opacity-30" style={{ animationDuration: '20s' }}>
            ...
            {/* Earth */}
            <div className="absolute top-3/4 right-1/4 animate-spin opacity-25" style={{ animationDuration: '25s' }}>
            ...
            {/* Mars */}
            <div className="absolute top-1/2 right-1/6 animate-spin opacity-20" style={{ animationDuration: '30s' }}>
            ...
            {/* Jupiter */}
            <div className="absolute top-1/6 right-1/3 animate-spin opacity-15" style={{ animationDuration: '35s' }}>
            ...
            {/* Moon */}
            <div className="absolute top-2/3 left-1/3 animate-spin opacity-35" style={{ animationDuration: '15s' }}>
